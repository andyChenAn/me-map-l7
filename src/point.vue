<template>
  ...
  <div id="map" class="map">
    <MeScene ref="sceneRef" v-bind="mapConfig">
      <MePointLayer v-bind="layerConfig">
...
import MePointLayer from './me-map-l7/components/point-layer/src/point-layer.vue'
