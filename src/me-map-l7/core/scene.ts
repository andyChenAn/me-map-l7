...
export default class MeScene {
  ...
  // L7标绘实例
  l7Draw: L7Draw | undefined = undefined;
  ...
  initScene (container: HTMLElement) {
    ...
    this.draw = new Draw(map , this.scene);
    this.l7Draw = new L7Draw(this.scene);
